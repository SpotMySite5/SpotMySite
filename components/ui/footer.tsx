  ...
  return (
    <footer>
      <div className="mx-auto max-w-6xl px-6 sm:px-6">
        {/* Top area: Blocks */}
        <div
          className={`flex flex-row max-lg:flex-wrap gap-10 py-8 md:py-12 ${border ? "border-t [border-image:linear-gradient(to_right,transparent,var(--color-slate-200),transparent)1]" : ""}`}
        >
          {/* 1st block */}
          <div className="basis-4/12 max-lg:basis-full max-lg:grow max-lg:order-4 max-lg:text-center">
            <div>
              <Image
          ...
          {/* 2nd block */}
          <div className="basis-3/12 max-lg:flex-none  max-md:basis-full max-lg:grow max-md:order-3">
          ...
          {/* 3rd block */}
          <div className="basis-3/12 max-lg:flex-none max-lg:basis-3/12 max-md:basis-1/2 max-md:grow">
          ...
          {/* 5th block */}
          <div className="basis-2/12 max-lg:flex-none ">
