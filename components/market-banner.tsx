...
export default function MarketBanner() {
  return (
    <section className="relative bg-gray-100 max-lg:rounded-bl-lg container-fluid">
      <div className="container-fluid mx-auto">
        <div className=" flex flex-row max-lg:flex-col-reverse gap-8 md:gap-12">
          {/* Section header */}
          <div className="banner_left basis-3/7 max-lg:basis-full mx-auto max-w-3xl pl-12 pr-12 lg:pt-0 lg:pb-0 lg:my-auto pb-24 max-lg:pt-0 max-lg:pb-10 max-lg:px-6 md:pb-20">
            ...
            <p className="mt-4 text-md font-(family-name:--font-service)">
              ...
              platform.{" "}
              <small>
                <a className="link" href="/market/about">
                  Explore More
                </a>
              </small>
            </p>
          ...
          <div className="banner_right basis-4/7 max-lg:basis-full overflow-hidden  text-center flex-shrink-0">
            {/* video */}
            <div className=" w-full h-72 max-lg:h-auto">
              {/* <img
