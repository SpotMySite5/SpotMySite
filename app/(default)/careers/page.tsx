      ...
      <section className="flex justify-center sec_careers " id="contact">
        <div className="container">
          <div className=" flex flex-row pt-12 max-lg:pt-5 max-md:flex-col-reverse">
            <div className="basis-1/2 overflow-hidden  px-12 pt-0 pb-24 max-lg:px-6 max-lg:pb-6 max-2xl:pb-20">
            ...
            <div className="basis-1/2 overflow-hidden flex justify-center px-12 pt-0 pb-24 max-lg:px-6 max-lg:pb-6 max-2xl:pl-12  max-2xl:pb-20">
              <Image
                className="relative"
                width={300}
                src={Career1}
          ...
          <div className=" flex flex-row pt-12 max-lg:pt-5 max-md:flex-col">
            <div className="basis-1/2 overflow-hidden flex justify-center max-lg:px-6 max-lg:pb-6 px-12 pt-0 pb-24 max-2xl:pl-12  max-2xl:pb-20">
              <Image
                className="relative"
                width={300}
                src={Career2}
            ...
            <div className="basis-1/2 overflow-hidden max-lg:px-6 max-lg:pb-6 px-12 pt-0 pb-24  max-2xl:pb-20">
              <h2 className="text-3xl font-bold md:text-4xl font-(family-name:--font-heading)">
                Our Mission & Story
              </h2>
          ...
          <div className=" flex flex-row pt-12 max-lg:pt-5">
            <div className=" overflow-hidden max-lg:px-6 max-lg:pb-6 px-12 pt-0 pb-24 max-2xl:pb-12">
              <h2 className="text-3xl font-bold md:text-4xl font-(family-name:--font-heading)">
                Life at SpotMySite
              </h2>
              <h3 className="mt-2 text-xl font-semibold md:text-2xl font-(family-name:--font-content)">
          ...
          <div className=" flex flex-row justify-center pt-0">
            <div className=" overflow-hidden flex justify-center max-lg:px-6 max-lg:pb-6 px-12 pt-0 pb-24 lg:pl-12  lg:pb-12">
              <Image
                className="relative"
                width={800}
                height={400}
          ...
          <div className=" flex flex-row pt-12 max-lg:pt-5">
            <div className=" overflow-hidden w-full max-lg:px-6 max-lg:pb-6 px-12 pt-0 lg:pb-10">
              <h2 className="text-3xl font-bold md:text-4xl font-(family-name:--font-heading)">
                Join Our Team
              </h2>
              <h3 className="mt-2 text-xl font-semibold md:text-2xl font-(family-name:--font-content)">
          ...
          <div className=" flex flex-row pt-0">
            <div className=" overflow-hidden max-lg:px-6 max-lg:pb-6 px-12 pt-0 pb-24 lg:pb-12">
              <h2 className="text-3xl font-bold md:text-4xl font-(family-name:--font-heading)">
                Don't See Your Role?
              </h2>
              <p className="mt-4 text-lg text-gray-700 font-(family-name:--font-content)">
